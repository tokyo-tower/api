...
const run_13 = require("./continuous/createPlaceOrderReport/run");
const run_14 = require("./continuous/createReturnOrderReport/run");
const run_15 = require("./continuous/payCreditCard/run");
const run_16 = require("./continuous/placeOrder/run");
const run_17 = require("./continuous/refundCreditCard/run");
const run_18 = require("./continuous/returnOrder/run");
const run_19 = require("./continuous/returnOrdersByPerformance/run");
...
const run_23 = require("./continuous/updateOrderReportByReservation/run");
const run_24 = require("./triggered/createEvents/run");
const run_25 = require("./triggered/importEvents/run");
const run_26 = require("./triggered/makeAggregationsExpired/run");
const run_27 = require("./triggered/syncCheckinGates/run");
