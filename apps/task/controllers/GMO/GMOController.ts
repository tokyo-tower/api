            ...
            ((err, result) => {
                ...
                Models.Reservation.find(
                    ...
                    (findReservationErr, reservations) => {
                        ...
                        if (findReservationErr) return this.next(findReservationErr, notification, cb);
                                ...
                                case GMOUtil.STATUS_CREDIT_CAPTURE:
                                    ...
                                    Models.Reservation.update(
                                        ...
                                        (updateErr, raw) => {
                                            ...
                                            if (updateErr) return this.next(updateErr, notification, cb);
                                            ...
                                            Models.ReservationEmailCue.findOneAndUpdate(
                                                ...
                                                (updateEmailCueErr, cue) => {
                                                    ...
                                                    if (updateEmailCueErr) return this.next(updateEmailCueErr, notification, cb);
                                ...
                                case GMOUtil.STATUS_CVS_EXPIRED: // 期限切れ
                                    ...
                                    Models.Staff.findOne(
                                        ...
                                        (findStaffErr, staff) => {
                                            ...
                                            if (findStaffErr) return this.next(findStaffErr, notification, cb);
