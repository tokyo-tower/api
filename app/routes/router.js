...
const requireScope_1 = require("../middlewares/requireScope");
 ...
 */
// search performances
router.get('/:locale/performance/search', requireScope_1.default(['performances.readonly']), setLocale_1.default, PerformanceController.search);
// 予約メール転送
